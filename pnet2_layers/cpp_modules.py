...
root_dir = '/home/peter/catkin_ws/src/pointnet2-tensorflow2/'
sampling_module = tf.load_op_library(root_dir + 'tf_ops/sampling/tf_sampling_so.so')
grouping_module = tf.load_op_library(root_dir + 'tf_ops/grouping/tf_grouping_so.so')
interpolate_module = tf.load_op_library(root_dir + 'tf_ops/3d_interpolation/tf_interpolate_so.so')
